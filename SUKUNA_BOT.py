...
def main_markup():
    ...
    markup.add(
        types.KeyboardButton("بوتات ارقام وهمية"), 
        types.KeyboardButton("حضر أرقام واتساب"),
        types.KeyboardButton("سحب أرقام يمن مبايل"), 
        types.KeyboardButton("حماية الوتس🛡"),
        types.KeyboardButton("سحب ارقام وتساب"), 
        types.KeyboardButton("📸 اختراق الكاميرا"),
        types.KeyboardButton("🎧تسجيل صوت"), 
        types.KeyboardButton("📱معلومات IP"),
        types.KeyboardButton("ادوات اضافية")
    )
    return markup
...
def handle_text(message):
    ...
    if not check_sub(user_id):
        bot.reply_to(message, f"❌ الوصول مرفوض! يرجى الاشتراك في القناة أولاً:\n{CHANNEL_URL}")
        return
    ...
    try:
        ...
        elif text in ["🎧تسجيل صوت", "📱معلومات IP", "📸 اختراق الكاميرا"]:
